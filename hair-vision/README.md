...
- **基础套餐**: Essential ($199/月, 200次), Professional ($499/月, 500次), Enterprise ($999/月, 2000次)
- **按需付费**: 超出基础信用后按次付费 ($0.06-$0.10/次，根据套餐)
- **智能降级**: 信用不足时自动降级到 Gemini Flash 模型（成本减半）
- **月度重置**: 基础信用每月自动重置

详细信用系统文档请参考 [CREDIT_SYSTEM.md](./CREDIT_SYSTEM.md)

### 成本示例（50 客户/天，3 视角/客户）

- **4K 分辨率**: ~$1,080/月
- **1K 分辨率**: ~$60/月
- **Professional 套餐**: $499/月 (包含 500 次) + 按需付费
- **节省**: ~$1,020/月 (94% 成本降低)
